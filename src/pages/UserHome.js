...
export default class Homepage extends React.Component{
    ...
    render(){
        ...
        return    <div className='imgC' style={StyleCont}>
                        ...
                        <div className='bttRes' style={ButtonRes(this.state.y,this.state.scrollY,this.state.mobile)} color="red">
                            <Button txt='POST JOB' fullW={true} Click={this.handleClick} msg='res'/>
                        </div> 
                        ...
                        <div className='bttExt' style={ButtonExt(this.state.x,this.state.y,this.state.scrollY,this.state.mobile)} color="primary">
                            <Button txt='FIND EXTRA' fullW={true} Click={this.handleClick} msg='ext'/>
                        </div> 
